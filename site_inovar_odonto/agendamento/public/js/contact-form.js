        ...
        send: function () {
            this.form.addEventListener('submit', function (e) {
                ...
                formData = {                    
                    ...
                    'telefone'   : document.querySelector('input[name="form-telefone"]').value,
                    'melhor-dia'   : document.querySelector('select[name="form-melhor-dia"]').value,
                    'melhor-periodo'   : document.querySelector('select[name="form-melhor-periodo"]').value,
                    'especialidade'   : document.querySelector('select[name="form-especialidade"]').value,
                    'clinica'  : document.querySelector('input[name="clinica"]:checked').value
                };
        ...
        feedback: function (data) {
            if (!data.success) {
                ...
                if (data.errors.message) {
                    var message = document.querySelector('select[name="form-unidade"]').parentNode,
                        error;
             ...
             if (data.errors.message) {
                    var message = document.querySelector('textarea[name="form-telefone"]').parentNode,
                        error;
